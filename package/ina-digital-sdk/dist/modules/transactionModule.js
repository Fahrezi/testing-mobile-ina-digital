...
exports.Transaction = {
    add(data, inaConst) {
        ...
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/transaction/create",
            data: data,
            headers: {
    ...
    update(data, inaConst) {
        ...
        data.tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/transaction/update/" + data.unique_id,
            data: data,
            headers: {
                "jwt_token": data.tokenUser,
                "secret_key": inaConst.secret_key,
    ...
    detail(data, inaConst) {
        ...
        const response = apiService_1.ServiceApi.GET({
            url: const_1.BASE_URL + "/external/transaction/detail/" + data.unique_id,
            params: data,
            headers: {
                "jwt_token": data.tokenUser,
                "secret_key": inaConst.secret_key,
    ...
    delete(data, inaConst) {
        ...
        data.tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/transaction/delete/" + data.unique_id,
            data: data,
            headers: {
                "jwt_token": data.tokenUser,
                "secret_key": inaConst.secret_key,
    ...
    list(params, inaConst) {
        ...
        data.tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.GET({
            url: const_1.BASE_URL + "/external/transaction/list",
            params: {
                page: params.page,
