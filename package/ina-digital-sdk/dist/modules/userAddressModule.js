...
exports.UserAddress = {
    getAddressDetail(idAddress, inaConst) {
        ...
        const response = apiService_1.ServiceApi.GET({
            url: const_1.BASE_URL + "/external/address/detail/" + idAddress,
            params: {
                "token": tokenUser
            },
            headers: {
    ...
    getAddressList(params, inaConst) {
        ...
        const tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.GET({
            url: const_1.BASE_URL + "/external/address/list",
            params: {
                "data": JSON.stringify({
    ...
    deleteAddress(idAddress, inaConst) {
        ...
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/address/delete/" + idAddress,
            headers: {
                "jwt_token": tokenUser,
                "secret_key": inaConst.secret_key,
            }
    ...
    updateAddress(idAddress, data, inaConst) {
        ...
        const tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/address/update/" + idAddress,
            headers: {
                "jwt_token": tokenUser,
                "secret_key": inaConst.secret_key,
            },
    ...
    createAddress(data, inaConst) {
        ...
        const tokenUser = getTokenUser(inaConst.mode);
        const response = apiService_1.ServiceApi.POST({
            url: const_1.BASE_URL + "/external/address/create",
            headers: {
                "jwt_token": tokenUser,
                "secret_key": inaConst.secret_key,
            },
